...
const PRIVATE_APPS: AppDefinition[] = [
  ...
  },
  {
    ...
    icon: "⬇️",
    category: "Hälsa",
    tags: ["Express", "SQLite", "Docker", "PIN", "Livsmedelsverket"],
    imageSeed: "tappavikt",
    status: "active",
    createdAt: "2026-09-04T06:00:00Z",
    type: "Web App",
    url: "https://tappavikt.alexcloud.se",
    banner: "linear-gradient(135deg, #16130f, #c1440e)",
    bannerEmoji: "⬇️",
  },
  {
    id: "mobil",
    title: "Mobiljämförelse",
    description: "Jämför mobilerbjudanden på total kostnad över tid i stället för prislapp. Telefon och abonnemang matas in var för sig, appen bygger kostnadstrappan och räknar in bindningstid, överlapp och restskuld.",
    icon: "📱",
    category: "Verktyg",
    tags: ["Express", "SQLite", "Docker", "Ekonomi"],
    imageSeed: "mobil",
    status: "active",
    createdAt: "2026-09-01T22:00:00Z",
    type: "Web App",
    url: "https://mobil.alexcloud.se",
    banner: "linear-gradient(135deg, #0c0a16, #7c5cff)",
    bannerEmoji: "📱",
  },
  {
    id: "glimmer",
    title: "Glimmer (ai-ps)",
    description: "AI-first bildredigerare för webben — ett modernt, generativt Photoshop-alternativ med WebGL2-motor (generative fill, bakgrundsborttagning, upscaling m.m.).",
    icon: "✨",
    category: "Kreativt",
    tags: ["React", "WebGL2", "TypeScript", "AI", "PIN"],
    imageSeed: "glimmer",
    status: "active",
  ...
  },
  {
    id: "token",
    title: "Token",
    description: "AI Token Tracker & Quota Dashboard för Claude och AGY (Google Antigravity). Se liveförbrukning, rullande 5-timmarsfönster, veckohistorik, dagsgrafer, modellfördelning och kvarvarande veckokvot.",
    icon: "⚡",
    category: "Verktyg",
    tags: ["Express", "Claude", "AGY", "Tokens", "Docker", "PIN"],
    imageSeed: "token",
    status: "active",
    createdAt: "2026-08-30T00:00:00Z",
    type: "Web App",
    url: "https://token.alexcloud.se",
    banner: "linear-gradient(135deg, #0f172a, #4f46e5, #10b981)",
    bannerEmoji: "⚡",
  },
  {
    id: "candid",
    title: "Candid",
    description: "Privat arkiv för de oarrangerade bilderna och klippen – de som inte hör hemma i något album. Hela sidan ligger bakom PIN-kod, och även bildfilerna kräver upplåst session, så ingenting går att nå med en direktlänk. Dra in bilder eller video var som helst på sidan: servern skalar om, plockar fram datumet ur filens egen metadata och gör en affischbild av klippen. iPhone-video kodas om så den faktiskt spelas i webbläsaren. Skriv en rad om varje minne, favoritmarkera, filtrera på klipp. Allt ligger i SQLite på egen volym – inget i den delade databasen.",
    icon: "🖼️",
    category: "Verktyg",
    tags: ["Express", "SQLite", "sharp", "ffmpeg", "PIN"],
    imageSeed: "candid",
    status: "active",
    createdAt: "2026-08-30T00:00:00Z",
    type: "Web App",
    url: "https://candid.alexcloud.se",
    banner: "linear-gradient(135deg, #0b0b0c, #2b2b30, #c9714a)",
    bannerEmoji: "📷",
  },
  {
    id: "assistenten",
  ...
  },
  {
    id: "stream",
    title: "Stream",
    description: "Register och streamingvault över filmer och serier. Hämtar affisch, genre, betyg och handling från TMDB och länkar till IMDb. Håll koll på vad du vill se, säsonger, eget betyg och sett-datum.",
    icon: "🎬",
    category: "Media",
    tags: ["Express", "TMDB", "IMDb", "Docker", "PIN"],
    imageSeed: "stream",
    status: "active",
    createdAt: "2026-08-23T00:00:00Z",
    type: "Web App",
    url: "https://stream.alexcloud.se",
    banner: "linear-gradient(135deg, #090d16, #4f46e5, #a855f7)",
    bannerEmoji: "🎬",
  },
  {
    id: "utgiftskollen",
...
const SYSTEM_APPS = [
  {
    id: "localsend-nod",
    title: "LocalSend-nod",
    description: "Servern som AirDrop-mottagare. Dyker upp som en enhet i LocalSend-appen på mobil och laptop; mottagna filer hamnar direkt i filsamlaren. Fungerar bara på det lokala nätet.",
    icon: "📥",
    category: "System",
    tags: ["Express", "Docker", "LocalSend", "LAN"],
    imageSeed: "localsend",
    status: "active",
    createdAt: "2026-08-23T00:00:00Z",
    type: "Web App",
    url: "http://192.168.0.155:3084",
    banner: "linear-gradient(135deg, #0b1614, #2dd4bf)",
    bannerEmoji: "📥",
  },
  {
    id: "puls",
